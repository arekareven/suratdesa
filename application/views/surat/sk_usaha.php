		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<div class="box-body">
						<form action="<?php echo base_url('SK_usaha/redirectLaporan'); ?>" id="main" name="main" method="POST" class="form-horizontal">

						<div class="form-group konfirmasi">
							<label for="keperluan"  class="col-sm-3 control-label">Jenis Surat</label>
								<div class="col-sm-3">
									<input class="form-control input-sm" name="nama_surat" id="nama_surat" type="text" value="Surat Keterangan Usaha" readonly>
								</div>
						</div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
             $('#nik').on('click',function(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('SK_usaha/get_warga')?>",
                    dataType : "JSON",
                    data : {nik: nik},
                    cache:false,
