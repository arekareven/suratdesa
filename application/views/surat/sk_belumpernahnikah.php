<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Keterangan Belum Pernah Menikah</h1>
			<ol class="breadcrumb">
				...
				<li class="active">Surat Keterangan Belum Pernah Menikah</li>
			</ol>
	</section>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<div class="box-body">
						<form action="<?php echo base_url('sk_belumpernahnikah/redirectLaporan'); ?>" id="main" name="main" method="POST" class="form-horizontal">

						<div class="form-group konfirmasi">
							<label for="keperluan"  class="col-sm-3 control-label">Jenis Surat</label>
								<div class="col-sm-3">
									<input class="form-control input-sm" name="nama_surat" id="nama_surat" type="text" value="Surat Keterangan Belum Menikah" readonly>
								</div>
						</div>
	...
	<div class="form-group">
		<label for="nomor" class="col-sm-3 control-label">Nomor Surat</label>
			<div class="col-sm-4">
				<input id="nomor" class="form-control input-sm digits required" type="text" placeholder="Nomor Surat" name="no_surat" value="<?php echo $invoice;?>">
			</div>
			<div class="col-sm-4">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
             $('#nik').on('click',function(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('SK_belumpernahnikah/get_warga')?>",
                    dataType : "JSON",
                    data : {nik: nik},
                    cache:false,
