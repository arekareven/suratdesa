<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Surat Keterangan KTP</li>
		</ol>
	</section>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<div class="box-body">
						<form action="<?php echo base_url('SK_ktp/redirectLaporan'); ?>" method="post" class="form-horizontal" role="form">


							<div class="form-group konfirmasi">
								<label for="keperluan" class="col-sm-3 control-label">Jenis Surat</label>
								<div class="col-sm-3">
									<input class="form-control input-sm" name="nama_surat" id="nama_surat" type="text" value="Surat Keterangan KTP" readonly>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<select type="text" class="form-control" id="ttd" name="ttd" required>
										<?php
										$opt = array('Harsono', 'Sekdes');
							...
							<script type="text/javascript">
								...
								$(document).ready(function() {
									$('#nik').on('click', function() {
										...
										$.ajax({
											type: "POST",
											url: "<?php echo base_url('SK_ktp/get_warga') ?>",
											dataType: "JSON",
											data: {
												nik: nik
											},
