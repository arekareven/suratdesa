<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Keterangan Bepergian / Jalan</h1>
			<ol class="breadcrumb">
				...
				<li class="active">Surat Keterangan Bepergian</li>
			</ol>
	</section>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<div class="box-body">
						<form action="<?php echo base_url('sk_berpergian/redirectLaporan'); ?>" id="main" name="main" method="POST" class="form-horizontal">

						<div class="form-group konfirmasi">
							<label for="keperluan"  class="col-sm-3 control-label">Jenis Surat</label>
								<div class="col-sm-3">
									<input class="form-control input-sm" name="nama_surat" id="nama_surat" type="text" value="Surat Keterangan Bepergian" readonly>
								</div>
						</div>
	...
	<div class="form-group">
		<label for="nomor" class="col-sm-3 control-label">Nomor Surat</label>
			<div class="col-sm-4">
				<input id="no_surat" class="form-control input-sm digits required" type="text" placeholder="Nomor Surat" name="no_surat" id="no_surat" value="<?php echo $invoice;?>">
			</div>
			<div class="col-sm-4">
				<p class="help-block"><em>Format nomor surat: </em><span id="format_nomor">474.2/000(Nomor Urut)/404.319.04/2019(Tahun)</span></p>
					...
					<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label">Tujuan</label>
							<div class="col-sm-3">
								<input class="form-control input-sm" name="tujuan" type="text" >
							</div>
					</div>
					...
					<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label">Batas Waktu</label>
							<div class="col-sm-2">
								<input class="form-control input-sm" name="tempat" type="date" > Sampai 
							</div>
					</div>
					...
					<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label"> </label>
							<div class="col-sm-2">
								<input class="form-control input-sm" name="keterangan" type="date" >
							</div>
					</div>
					<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label">Pengikut</label>
							<div class="col-sm-3">
		...
		<label for="keperluan"  class="col-sm-3 control-label">Tanggal Surat</label>
			<div class="col-sm-3">
				<input class="form-control input-sm" name="tanggal_surat" type="text" value="<?php echo date("d-m-Y"); ?>" readonly>
					...
					<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label">TTD</label>
							<div class="col-sm-3">
							<select type="text" class="form-control" id="agama" name="agama" required>
                            <?php
                            $opt = array('Kades', 'Sekdes');
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
             $('#nik').on('click',function(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('SK_berpergian/get_warga')?>",
                    dataType : "JSON",
                    data : {nik: nik},
                    cache:false,
