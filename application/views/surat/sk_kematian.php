<div class="content-wrapper">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<div class="box-body">
						<form action="<?php echo base_url('sk_kematian/redirectLaporan'); ?>" id="main" name="main" method="POST" class="form-horizontal">

						<div class="form-group konfirmasi">
		<label for="keperluan"  class="col-sm-3 control-label">Jenis Surat</label>
			<div class="col-sm-3">
				<input class="form-control input-sm" name="nama_surat" id="nama_surat" type="text" value="Surat Keterangan Kematian" readonly>
			</div>
	</div>
	...
	<div class="form-group">
		<label for="nomor" class="col-sm-3 control-label">Nomor Surat</label>
			<div class="col-sm-4">
				<input id="nomor" class="form-control input-sm digits required" type="text" placeholder="Nomor Surat" name="no_surat" id="no_surat" value="<?php echo $invoice;?>">
			</div>
			<div class="col-sm-4">
			...
			<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label">Hari/Tanggal Kematian</label>
							<div class="col-sm-3">
								<input class="form-control input-sm" name="keperluan" type="text" >
							</div>
					</div>

					<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label">Tempat Kematian</label>
							<div class="col-sm-3">
								<input class="form-control input-sm" name="tempat" type="text" >
							</div>
					</div>

					<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label">Sebab Kematian</label>
							<div class="col-sm-3">
								<input class="form-control input-sm" name="alasan" type="text" >
							</div>
					</div>
					<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label">Yang Menentukan</label>
							<div class="col-sm-3">
								<input class="form-control input-sm" name="isian" type="text" >
							</div>
					</div>

					<div class="form-group">
						<label for="keperluan"  class="col-sm-3 control-label">Keterangan Visum</label>
							<div class="col-sm-3">
								<input class="form-control input-sm" name="keterangan" type="text" >
							</div>
					</div>
		...
		<label for="keperluan"  class="col-sm-3 control-label">Tanggal Surat</label>
			<div class="col-sm-3">
				<input class="form-control input-sm" name="tanggal_surat" type="text" value="<?php echo date("d-m-Y"); ?>" readonly>
			</div>
	</div>	
				<input type="hidden" name="nik2" id="nik2">
				<button type="submit" class="btn btn-social btn-flat btn-success btn-sm pull-right" style="margin-right: 5px;"><i class="fa fa-file-text"></i>Buat Surat</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
             $('#nik').on('click',function(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('SK_kematian/get_warga')?>",
                    dataType : "JSON",
                    data : {nik: nik},
                    cache:false,
